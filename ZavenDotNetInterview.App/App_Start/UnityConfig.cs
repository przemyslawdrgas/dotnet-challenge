...
namespace ZavenDotNetInterview.App
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterInstance<IZavenDotNetInterviewContext>(new ZavenDotNetInterviewContext(), InstanceLifetime.PerContainer);
            container.RegisterType<IJobProcessorService, JobProcessorService>();
            container.RegisterType<IJobLoggingService, JobLoggingService>();
            container.RegisterType<IJobService, JobService>();
            container.RegisterType<IJobValidatorService, JobValidatorService>();
        }
    }
}